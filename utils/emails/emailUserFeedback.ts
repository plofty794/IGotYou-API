export const emailUserFeedback = (
  name: string,
  email: string,
  sentAt: string,
  feedback: string
...
<body>
  <div class="container">
  <h1>User Feedback</h1>
                <p>A user has submitted feedback regarding the platform.</p>
                ...
                <p class="paragraph">The feedback provided:</p>
                <p class="paragraph">${feedback}</p>
                <hr style="width:100%;border:none;border-top:1px solid #eaeaea;border-color:#e6ebf1;margin:20px 0" />
